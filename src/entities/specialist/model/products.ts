...
export const PRODUCTS: Product[] = [
    {
        ...
        images: ['/images/products/anatomical_insoles.webp', '/images/products/anatomical_insoles_beige.webp', '/images/products/anatomical_insoles_blue_camo.webp', '/images/products/anatomical_insoles_blue.webp', '/images/products/anatomical_insoles_coloured.webp'],
        type: "insoles",
    },
    {
        id: '1',
